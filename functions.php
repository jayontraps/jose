...
function jose_scripts() {
	...
	wp_enqueue_style( 'jose-style', get_template_directory_uri() . '/build/css/main.css', array(), '20200601' );
	...
	wp_enqueue_script( 'jose-build', get_template_directory_uri() . '/build/js/all.min.js', array('jquery'), '20200601', true );
